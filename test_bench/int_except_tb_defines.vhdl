...
package int_except_tb_defines is
	...
	--- Test structures
	---------------------------------------------------------------
	type TEST_ADDRESS_TYPE is array(0 to 2) of std_logic_vector(ADDR_WIDTH-1 downto 0);
	type TEST_VALUES_TYPE  is array(0 to 2) of std_logic_vector(DATA_WIDTH-1 downto 0);
