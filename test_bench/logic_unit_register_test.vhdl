...
begin
	...
	instruction <= test_case.opcode & IU_LOGIC & AM_RRR & "00001" & "00010" & "00011" & "000" when rr_instr = '0' else (others => 'Z');
	instruction <= test_case.opcode & IU_LOGIC & AM_R_R & "00001" & "00010" & "00011" & "000" when rr_instr = '1' else (others => 'Z');
